...
function renderRecibo() {
  ...
  document.getElementById("recibo-form").addEventListener("submit", (e) => {
    ...
    doc.setFillColor(255, 204, 153); // fundo laranja claro
    doc.rect(80, y - 7, larguraValor, 12, "F");
    doc.setTextColor(0, 0, 0);
    doc.setFontSize(14);
    doc.text(valorTexto, 84, y);
    ...
    doc.setFillColor(255, 229, 204); // fundo laranja bem clarinho
    doc.rect(80, y - 7, larguraExt, 12, "F");
    doc.setFont("helvetica", "bold");
    doc.setFontSize(12);
    doc.setTextColor(0, 0, 0);
    doc.text(extensoTexto, 84, y);
